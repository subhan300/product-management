    ...
    var zn = function() {
        ...
        Bn = function() {
            ...
            return e.prototype.setProp = function(e, t) {
                ...
                else if ("id" === e) t = Gt[e](t), this.mutate({
                    standardProps: {
                        publicId: t
                    }
                });
    ...
    var Jo = function() {
        ...
        return e.prototype.resetOptions = function(e, t) {
            ...
            var e, t, n, o, i, a, s, l, u, c = this.props,
                ...
                y = f.calendarOptions;
            if (m && m !== y)
                for (var E in m.timeZone !== y.timeZone && (d.eventSources = v.eventSources = (a = v.eventSources, s = d.dateProfile, l = v, u = s ? s.activeRange : null, Po(a, Ho(a, l), u, !0, l)), d.eventStore = v.eventStore = (e = v.eventStore, t = p.dateEnv, n = v.dateEnv, o = e.defs, i = Ue(e.instances, (function(e) {
                        var i = o[e.defId];
